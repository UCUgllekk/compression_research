...
Основні методи:
generate_code: генерує коди Хаффмана для всіх символів на основі наданого дерева Хаффмана.
encode: кодує вхідний текст за допомогою кодування Хаффмана і повертає закодовану послідовність бітів разом зі словником Хаффмана.
frequency: обчислює частоту всіх символів у вхідному тексті.
decode: декодує вхідну послідовність бітів, використовуючи наданий словник Хаффмана.
add_fictious_bins: додає фіктивні біти в кінець закодованих даних для вирівнювання байтів.
remove_fictious: видаляє фіктивні біти, додані під час стиснення.
dict_to_bytes і dict_from_bytes: перетворюють словники Хаффмана у байти і навпаки.
compress: стискає файл за допомогою кодування Хаффмана і записує стиснуті дані до нового файлу.
decompress: розпаковує файл, стиснутий за допомогою кодування Хаффмана, і записує розпаковані дані до нового файлу.
клас Node - використовується для створення дерева, і подальшого опрацювання.
